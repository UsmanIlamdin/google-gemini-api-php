...
use CurlHandle;
use GeminiAPI\Requests\GenerateCachedContentRequest;
use GeminiAPI\Resources\CachedContents;
use GeminiAPI\Resources\Files;
use GeminiAPI\Resources\Media;
...
class Gemini implements GeminiClientInterface
{
    ...
    public function geminiPro15Flash001(): GenerativeModel
    {
        return $this->generativeModel(ModelName::GeminiPro15Flash001);
    }
     ...
     * @throws ClientExceptionInterface
     */
    public function generateContentWithCache(GenerateCachedContentRequest $request): GenerateContentResponse
    {
        $response = $this->doRequest($request);
        $json = json_decode($response, associative: true);
    ...
    {
        return new CachedContents($this->apiKey);
    }
